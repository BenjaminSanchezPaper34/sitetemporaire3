...
const OCCASIONS = [
  {
    title: "Sea-Doo GTI SE 170 — 2022",
    price: "12 900",
    hours: "65h",
    description: "Révisé en atelier, garantie 3 mois. Parfait état, housse incluse.",
    tag: "Coup de coeur",
  },
  {
    title: "Sea-Doo RXP-X 300 — 2021",
    price: "18 500",
    hours: "42h",
    description: "Modèle performance, entretien complet effectué. Remorque incluse.",
    tag: "Sportif",
  },
  {
    title: "Sea-Doo Spark Trixx 2UP — 2023",
    price: "7 900",
    hours: "30h",
    description: "Idéal débutant, léger et maniable. Révisé, prêt à naviguer.",
    tag: "Petit budget",
  },
];
  ...
  return (
    <section className="relative py-24 lg:py-32 bg-[#08080a]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div data-reveal data-reveal-stagger="true" className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {OCCASIONS.map((item) => (
            ...
            >
              ...
              <div className="relative h-48 bg-gradient-to-br from-accent/20 via-gray-900 to-black overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <svg className="text-white/10" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="0.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Trust bar */}
        <div data-reveal className="mt-8 flex flex-wrap items-center justify-center gap-6 text-xs text-gray-500">
